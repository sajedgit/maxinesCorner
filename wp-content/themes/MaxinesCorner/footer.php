  ...
  <script src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/jquery.scrollTo.js"></script>
  <script src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/jquery.appear.js"></script>
  <script src="<?php echo esc_url( get_template_directory_uri() ); ?>/js/stellar.js"></script>
  <script src="<?php echo esc_url( get_template_directory_uri() ); ?>/plugins/cubeportfolio/js/jquery.cubeportfolio.min.js"></script>
